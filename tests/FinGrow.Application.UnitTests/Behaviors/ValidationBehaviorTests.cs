...
public class ValidationBehaviorTests
{
    ...
    {
        var behavior = new ValidationBehavior<FakeRequest, Result>(new[] { new FakeValidator() });
    ...
    {
        var behavior = new ValidationBehavior<FakeRequest, Result<string>>(new[] { new FakeValidator() });
    ...
    {
        var behavior = new ValidationBehavior<FakeRequest, Result>(Array.Empty<IValidator<FakeRequest>>());
        var handlerWasInvoked = false;
